    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ url('/riwayat_pembelian_barang') }}" method="post">
                ...
                <div class="form-group">
                    <label for="examplekode_pembelian">Kode Barang</label>
                    <input type="text" name="kode_barang" class="form-control" id="examplekode_pembelian" aria-describedby="kode_pembelian" placeholder="Kode Pembelian">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="exampledeskripsi">Point</label>
                    <input type="text" name="point" class="form-control" id="exampledeskripsi" aria-describedby="deskripsi" placeholder="Deskripsi">
                </div>
                <div class="form-group">
